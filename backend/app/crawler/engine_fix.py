...
from app.crawler.normalizer import normalize_url, is_internal_url, extract_domain, is_crawlable
...
class CrawlerEngine:
    ...
    async def _crawl_url(self, url: str, depth: int, parent_url: str = None):
        ...
        try:
            ...
            if page_is_html and not self._stop_requested:
                for link in links:
                    if self._stop_requested:
                        break
